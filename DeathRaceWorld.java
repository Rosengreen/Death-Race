...
public class DeathRaceWorld extends World
{
    ...
    public DeathRaceWorld(boolean gameStarted)
    {
        ...
        if (gameStarted)
        {
            ...
            addObject(new Player1(), 60, WORLD_HEIGHT - 50);
            addObject(new Player2(), 60, WORLD_HEIGHT - 50);
            addObject(new Player3(), 60, WORLD_HEIGHT - 50);
            addObject(new Player4(), 60, WORLD_HEIGHT - 50);
